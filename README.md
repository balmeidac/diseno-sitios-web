...
A continuación presento las unidades de estudio y los enlaces a las prácticas correspondientes de cada semana.
...
| :--- | :---: | :--- |
| **1.1** Introducción a la web (HTTP/HTTPS) | ⏳ | [_Pendiente_](./semana-01) |
| **1.2** Normas W3C y Accesibilidad (WCAG) | ⏳ | [_Pendiente_](./semana-02/) |
...
| Tema | Estado | Carpeta / Práctica |
| :--- | :---: | :--- |
| **3.1** Fundamentos CSS (Selectores, Colores) | ⏳ | _Pendiente_ |
| **3.2** El Modelo de Caja (Box Model) | ⏳ | _Pendiente_ |
| **3.3** Diseño Responsive (Flexbox & Grid) | ⏳ | _Pendiente_ |
